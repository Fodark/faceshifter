...
class AEINet(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        if optimizer_idx == 0:
            ...
            loss_GAN = self.Loss_GAN(
                output_multi_scale_val, True, for_discriminator=False
            )
            loss_E_G, loss_att, loss_id, loss_rec = self.Loss_E_G(
                target_img,
                output,
                feature_map,
                output_feature_map,
    ...
    def train_dataloader(self):
        ...
        return DataLoader(
            ...
            num_workers=self.hp.model.num_workers,
            shuffle=True,
            drop_last=True,
        )
